...
export default function DashboardPreview() {
  ...
  return (
    <section className="py-20 md:py-28 bg-powder" ref={ref}>
      <Container>
        <SectionHeading
          label="Dashboard"
...
function FullDashboardSvg() {
  return (
    <svg viewBox="0 0 900 500" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto" preserveAspectRatio="xMidYMid meet">
      ...
      {[230, 260, 290, 320].map((y, i) => (
        <line key={y} x1="244" y1={y} x2="632" y2={y} stroke="#D9E8E2" strokeWidth="1" strokeDasharray="3" />
      ))}
      <text x="238" y="234" fill="#114C5A" fontSize="9" fontFamily="Inter" textAnchor="end">$80k</text>
      <text x="238" y="264" fill="#114C5A" fontSize="9" fontFamily="Inter" textAnchor="end">$60k</text>
      <text x="238" y="294" fill="#114C5A" fontSize="9" fontFamily="Inter" textAnchor="end">$40k</text>
      <text x="238" y="324" fill="#114C5A" fontSize="9" fontFamily="Inter" textAnchor="end">$20k</text>

      <path d="M260 320 L290 300 L320 310 L350 280 L380 260 L410 250 L440 240 L470 230 L500 220 L530 210 L560 200 L590 195 L620 190" stroke="#FFC801" strokeWidth="2.5" fill="none" strokeLinecap="round" />
      <path d="M620 190 L632 185" stroke="#FF9932" strokeWidth="2" strokeDasharray="4 3" fill="none" strokeLinecap="round" />
      <circle cx="620" cy="190" r="3" fill="#FFC801" />

      {[260, 300, 340, 380, 420, 460, 500, 540, 580, 620].map((x, i) => (
        <text key={x} x={x} y="358" fill="#114C5A" fontSize="8" fontFamily="Inter" textAnchor="middle">
          {['J','F','M','A','M','J','J','A','S','O'][i]}
        </text>
      ))}
